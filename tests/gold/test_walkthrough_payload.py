...
def test_build_walkthrough_payload_uses_current_silver_reference_tables(tmp_path: Path) -> None:
    ...
    write_parquet(
        ...
        [
            {"pokemon_species": "bulbasaur", "name": "bulbasaur", "url": "https://pokeapi.co/api/v2/pokemon/1/"},
            {"pokemon_species": "geodude", "name": "geodude", "url": "https://pokeapi.co/api/v2/pokemon/74/"},
            {"pokemon_species": "pidgey", "name": "pidgey", "url": "https://pokeapi.co/api/v2/pokemon/16/"},
        ],
    )
    write_parquet(
        references_dir / "move_reference.parquet",
